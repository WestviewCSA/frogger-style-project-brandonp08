...
public class Noodle{
	...
	public Noodle() {
		forward 	= getImage("/imgs/"+"Noodle.png"); //load the image for Tree
	...
	public boolean collided (TWODFromGorillaz character) {
		...
		Rectangle thisObject = new Rectangle(x+10, y+15, width-23, height-20);
	...
	public void paint(Graphics g) {
		...
		if(Frame.debugging) {
			...
			g.drawRect(x+10, y+ 15, width-23, height-20);
		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = Noodle.class.getResource(path);
